...
function App() {
  ...
  return (
    <>
      <section className="section doubt-solve">
        <h2 className="doubt-solve-heading fw-400">
          Instant{" "}<span className="text-pink fw-700">Doubt Solving</span>
        </h2>
        <div className="doubt-main">
          <div className="doubt-left">
            <svg className='doubt-design' xmlns="http://www.w3.org/2000/svg" width="526" height="249" viewBox="0 0 526 249" fill="none">
              <g opacity="0.4">
            ...
            <div className="doubt-card doubt-card1">
              <div className="dc-left">
                <img src={Chat} alt="Chat Doubt Image" />
              </div>
              <div className="dc-right">
                <p className="dc-heading">Doubts Solved in 5-10 min</p>
                <p className="dc-text">
                  Ask your doubts when you want, and get it solved within 5-10 minutes
                </p>
              </div>
            </div>
            <div className="doubt-card doubt-card2">
              <div className="dc-left">
                <img src={Read} alt="Read Doubt Image" />
              </div>
              <div className="dc-right">
                <p className="dc-heading">Experience 1 to 1 learning</p>
                <p className="dc-text">
